...
3. 向目标供应商施压时，请使用“份额分配”作为核心筹码。可以明确告知对方：由于价格原因，本次我们打算将一部分份额（如 10%-20% 或 XX%）划给新渠道做灰度测试；如果他们愿意把价格降到目标价，可以保留他们原有的供货份额。
4. 话术不宜过长，分段清晰，可适当使用emoji（如🤝, 🙏, 😅等）。
5. 结尾要留有余地，促使对方尽快回复或申请特批。
...
- 如果常用供应商价格偏高，请强烈建议采用“份额切割”策略：例如将 10%-20% 的订单切给最低价的新供应商进行灰度测试，以此向常用供应商施压降价。
...
4. 称呼对方为“王总/李总”等通用称呼。
5. 向目标供应商施压时，请把“份额分配”作为谈判筹码：明确告知对方，由于价格原因，本次我们打算将 XX% 的份额划给新渠道测试；如果他们愿意将价格降至目标价，我们可以保留他们原有的供货份额。"""
